                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h4 fw-bold mb-5 mx-1 mx-md-4 mt-4">Log in or Register Now</p>
...
{{-- <div class="col-md-12">
                    <div class="col-md-6 img-thumbnail" style="width: 400px; height: 400px;">
                        <img src="{{ asset('img/0.png') }}" alt="">
                    </div>
                    <div class="col-md-6">
                        <div
